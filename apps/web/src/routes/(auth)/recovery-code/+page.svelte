...
<Card.Root class="mx-auto max-w-sm sm:w-96">
	<Card.Header>
		...
		<Card.Description>
			Your recovery code is used to recover your account if you lose access to your second factors.
		</Card.Description>
	</Card.Header>
	<Card.Content>
		<div class="grid w-full gap-4">
			<div class="grid gap-2">
				...
				<div class="flex gap-2">
					<Input id="recovery-code" type="text" value={data.recoveryCode} readonly class="flex-1" />
			...
			<div class="h-4">
				{#if copied}
					<p transition:fade class="text-center text-sm" aria-live="polite">Copied to clipboard!</p>
				{/if}
			</div>
		</div>
	</Card.Content>
